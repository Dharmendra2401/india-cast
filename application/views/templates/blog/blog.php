												...
												<div class="row">
													<div class="col-lg-6">
														...
														<a href="<?php echo base_url('blog/blog_details/'.$param['id'])?>">
															<img width="1200" height="710" src="<?php echo base_url('images/blog/'.$param['blog_images'])?>" class="attachment-blogberg-1200-710 size-blogberg-1200-710 wp-post-image" alt="" /></a>
														</figure>
													</div> <!-- end col-lg-6 -->
														<div class="col-lg-6">
															<div class="post-content">
																<header class="entry-header">
																	<div class="entry-meta-cat">
																		<a href="<?php echo base_url('blog/blog_details/'.$param['id'])?>"><?php  echo $this->db->get_where('blog_category', array('id'=>$param['blog_category_id']))->row()->name;  ?></a>
																	</div>
																	<h3 class="entry-title">
																		<a href="<?php echo base_url('blog/blog_details/'.$param['id'])?>"><?php echo $param['blog_title']?></a>
																	</h3>
																	<div class="meta-tag">
																		<div class="meta-time">
																			<a >
