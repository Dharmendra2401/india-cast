	...
	<div class="box-shadowssss">
      <div class="row">
		...
		<div class="col-sm-6 col-md-12 col-lg-12 col-xl-12">
		  	<p style="top: 345px;left: 254px;width: 858px;height: 38px;margin-left: 11%;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
		</div>
			...
			<div class="tab-content ">
				 <div class="tab-pane active" id="1">
          			<div class="row row-image-team">
						<div class="col-sm-6 col-md-12 col-lg-12 col-xl-12">
							<h6  class="career-desc-heading"><span class="bottom-border-job-desc" style="color: red; font-size:18px!important;">IT</span></h6>
							<p  class="career-desc-heading" style="font-size: 14px!important;">All open positions</p>
							<div class="image-team">
								<div class="row row-image-team">
									<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 " >
										<div class="column">
										    <div class="card" style="top: 89px;left: 139px; width: 559px;height: 110px;opacity: 70%;margin-bottom: 26%;border-left: 5px solid red;">
										    	<a href="<?php echo base_url()?>home/career_desc">
										    		<h4 style="margin-right: 44%; color: red">Business Devlopment Manager</h4>
										    	</a>
										    	<div style="margin-left: 5%;">
										    		<p style="width: 441px;">We would like to hear from target-oriented, focused indivisuals with a flair of creativity and have exceptional commuincation skills.</p>
										    	</div>
										    </div>
									  	</div>
									</div>
						...
						<img class="img-responsive mrgn-img img-founder career-arrow-style cur" onclick="myFunction()" src="<?php echo base_url()?>images/arrowheads.svg">
          			</div>
				</div>
