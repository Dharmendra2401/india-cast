...
<table id="example1" class="table table-striped table-bordered " width='100%'>
                            ...
                            <?php $i=1;foreach($row as $index)  {
                                ...
                                <tr >
                                    ...
                                    <a href="#" title="Click here to deactive" data-toggle="modal"  onclick="return unverify('<?php echo $index['id']; ?>','N','aspprofile_type');" class="rounded btn btn-sm btn-success"><i class="fas fa-check"></i></a>
                                    <?php }else{ ?>
                                    <a href="#" title="Click here to active" data-toggle="modal"  onclick="return verify('<?php echo $index['id']; ?>','Y','aspprofile_type');" class="rounded btn btn-sm btn-danger"><i class="fas fa-times"></i></a>
                                    <?php } ?> 
