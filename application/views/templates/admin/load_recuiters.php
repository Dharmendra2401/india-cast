<table id="example1" class="table table-striped table-bordered " width='100%'>
                            ...
                            <?php $i=1;foreach($row as $index)  { 
                                ...
                                <tr class="row<?php echo $i; ?>">
                                    ...
                                    <a href="#" title="View details" data-toggle="modal" data-target="#update" onclick="return update('<?php echo $index['category']; ?>','<?php echo $index['firstname']; ?>','<?php echo $index['lastname']; ?>','<?php echo $index['contact_no']; ?>','<?php echo $index['company_name']; ?>','<?php echo $index['logo']; ?>','<?php echo $index['email']; ?>','<?php echo date('d/m/Y h:m:s A',strtotime($index['date_created'])); ?>','<?php echo base64_encode($emailstatus); ?>','<?php echo $index['registration_no']; ?>','<?php echo $index['pan']; ?>','<?php echo $index['gst']; ?>','<?php echo base64_encode($index['address']); ?>','<?php echo $index['purpose']; ?>','<?php echo base64_encode($status); ?>','<?php echo date('d/m/Y h:m:s A',strtotime($index['update_date'])); ?>','<?php echo $index['id_proof']; ?>','<?php echo $index['company']; ?>');" class="rounded btn btn-sm btn-success"><i class="fas fa-eye"></i></a> <br> 
