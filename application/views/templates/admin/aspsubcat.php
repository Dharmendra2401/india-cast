...
$title="Sub Category of ". $getname['name'];  ?>;
?>
...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/aspsubcat" enctype='multipart/form-data'>
                    <input type="hidden" name="ucatidd" value="<?php echo $getid; ?>">
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Sub Category</label><br>
                            <input type="text" name="uname" id="uname" placeholder="Enter sub category" class="form-control" maxlength="50">
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <input type="hidden" name="catidd" value="<?php echo $getid; ?>">
                        ...
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Sub Category</label><br>
                            <input type="text" name="name" id="name" placeholder="Enter sub category" class="form-control" maxlength="50">
                        </div>
                        <span id="jerror"></span>
...
if(Category.trim()==''){
   ...
   $('#jerror').html('<div class="alert alert-danger alert-dismissible fade show" role="alert">Please enter sub Category name <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
    return false;
}
else{
    return true;
...
if(Category.trim()==''){
   ...
   $('#ujerror').html('<div class="alert alert-danger alert-dismissible fade show" role="alert">Please enter sub Category name <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
    return false;
}
else{
    return true;
