...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/aspcat" enctype='multipart/form-data'>
                    
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Category</label><br>
                            <input type="text" name="uname" id="uname" placeholder="Enter Category" class="form-control" maxlength="50">
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>admin/aspcat" enctype='multipart/form-data'>
                        ...
                        <div class="form-group">
                            <label><span class="text-danger">*</span> Category</label><br>
                            <input type="text" name="name" id="name" placeholder="Enter Category" class="form-control" maxlength="50">
                        </div>
                        <span id="jerror"></span>
